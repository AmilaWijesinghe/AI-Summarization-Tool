  ...
  return (
    <section className="max-w-7xl mx-auto ">
        <div>
            ...
            <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">Create imaginative and visual stunning images genarated by DALLE-AI</p>
        </div>
        <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
          ...
          <div className=" mt-5 flex gap-5  ">
              ...
              >
                {genaratingImg ? 'Generating...' : 'Generate'}
              </button>
          </div>
          <div className="mt-10">
            <p className="mt-2 text-[#666e75] text-[14px] "> Once you have generate image you can share community</p>
            <button
              type="submit"
